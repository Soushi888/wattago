...
<head>
	...
	<link rel="icon" href="images/Wattago-logo-original.png" type="image/x-icon">
...
<body>
	...
	<div id="page" class="page">
		...
		============================================= -->
		<section>
			<div class="container chero-txt text-center mb-40">
				<img src="images/Wattago-logo-original.png" alt="Logo Wattago" width="250">
			</div>
		</section>
		...
		<section id="hero-14" class="bg-fixed hero-section division">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hero-14-img text-center">
							<img class="img-fluid" src="images/hero-14-img.png" alt="hero-image">
						</div>
					</div>
				</div> <!-- END HERO IMAGE -->
				...
				<div class="row">
					<div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
						<div class="row">
							...
							<!-- PRICE PLAN FREE -->
							<div class="col-md-6">
								<div class="pricing-table wow fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">

									<!-- Icon  -->
									<div class="price-icon">
										<img class="img-130" src="images/client.png" alt="price-icon" />
									</div>
							...
							<!-- PRICE PLAN PRO -->
							<div class="col-md-6">
								<div class="pricing-table wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.3s">

									<!-- Icon  -->
									<div class="price-icon">
										<img class="img-130" src="images/fournisseur.png" alt="price-icon" />
									</div>
